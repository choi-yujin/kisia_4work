...
const RULE_NAME$P = "prefer-lowercase-title";
...
const RULE_NAME$O = "max-nested-describe";
...
const RULE_NAME$N = "no-identical-title";
...
const RULE_NAME$M = "no-focused-tests";
...
const RULE_NAME$L = "no-conditional-tests";
...
const RULE_NAME$K = "expect-expect";
...
const RULE_NAME$J = "consistent-test-it";
...
const RULE_NAME$I = "prefer-to-be";
...
const RULE_NAME$G = "no-restricted-vi-methods";
...
const RULE_NAME$F = "consistent-test-filename";
...
const RULE_NAME$D = "no-alias-methods";
...
const RULE_NAME$C = "no-commented-out-tests";
...
const RULE_NAME$B = "no-conditional-expect";
...
const RULE_NAME$A = "no-import-node-test";
...
const RULE_NAME$z = "no-conditional-in-test";
...
const RULE_NAME$y = "no-disabled-tests";
...
const RULE_NAME$x = "no-done-callback";
...
const RULE_NAME$w = "no-duplicate-hooks";
...
const RULE_NAME$v = "no-large-snapshots";
...
const RULE_NAME$u = "no-interpolation-in-snapshots";
...
const RULE_NAME$t = "no-mocks-import";
...
const RULE_NAME$s = "no-restricted-matchers";
...
const RULE_NAME$r = "no-standalone-expect";
...
const RULE_NAME$q = "no-test-prefixes";
...
const RULE_NAME$p = "no-test-return-statement";
const getBody = (args) => {
...
const RULE_NAME$o = "prefer-called-with";
...
const RULE_NAME$m = "valid-expect";
...
const RULE_NAME$l = "prefer-to-be-object";
...
const RULE_NAME$k = "prefer-to-be-truthy";
...
const RULE_NAME$j = "prefer-to-be-falsy";
...
const RULE_NAME$i = "prefer-to-have-length";
...
const RULE_NAME$h = "prefer-equality-matcher";
...
const RULE_NAME$g = "prefer-strict-equal";
...
const RULE_NAME$f = "prefer-expect-resolves";
...
const RULE_NAME$d = "prefer-hooks-on-top";
...
const RULE_NAME$c = "prefer-hooks-in-order";
...
const RULE_NAME$b = "prefer-mock-promise-shorthand";
...
const RULE_NAME$a = "prefer-snapshot-hint";
...
const RULE_NAME$9 = "valid-describe-callback";
...
const RULE_NAME$8 = "require-top-level-describe";
...
const RULE_NAME$6 = "require-hook";
...
const RULE_NAME$5 = "require-local-test-context-for-concurrent-snapshots";
...
const RULE_NAME$3 = "prefer-spy-on";
...
const RULE_NAME$2 = "prefer-comparison-matcher";
const isString = (node) => {
...
const RULE_NAME$1 = "prefer-to-contain";
...
const index = {
  rules: {
    [RULE_NAME$P]: lowerCaseTitle,
    [RULE_NAME$O]: maxNestedDescribe,
    [RULE_NAME$N]: noIdenticalTitle,
    [RULE_NAME$M]: noFocusedTests,
    [RULE_NAME$L]: noConditionalTest,
    [RULE_NAME$K]: expectExpect,
    [RULE_NAME$J]: consistentTestIt,
    [RULE_NAME$I]: preferToBe,
    [RULE_NAME$H]: noHooks,
    [RULE_NAME$G]: noRestrictedViMethods,
    [RULE_NAME$F]: consistentTestFilename,
    [RULE_NAME$E]: maxExpect,
    [RULE_NAME$D]: noAliasMethod,
    [RULE_NAME$C]: noCommentedOutTests,
    [RULE_NAME$B]: noConditionalExpect,
    [RULE_NAME$z]: noConditionalInTest,
    [RULE_NAME$y]: noDisabledTests,
    [RULE_NAME$x]: noDoneCallback,
    [RULE_NAME$w]: noDuplicateHooks,
    [RULE_NAME$v]: noLargeSnapshots,
    [RULE_NAME$u]: nonInterpolationInSnapShots,
    [RULE_NAME$t]: noMocksImport,
    [RULE_NAME$s]: noRestrictedMatchers,
    [RULE_NAME$r]: noStandaloneExpect,
    [RULE_NAME$q]: noTestPrefixes,
    [RULE_NAME$p]: noTestReturnStatement,
    [RULE_NAME$A]: noImportNodeTest,
    [RULE_NAME$o]: preferCalledWith,
    [RULE_NAME$n]: validTitle,
    [RULE_NAME$m]: validExpect,
    [RULE_NAME$j]: preferToBeFalsy,
    [RULE_NAME$l]: preferToBeObject,
    [RULE_NAME$k]: preferToBeTruthy,
    [RULE_NAME$i]: preferToHaveLength,
    [RULE_NAME$h]: preferEqualityMatcher,
    [RULE_NAME$g]: preferStrictEqual,
    [RULE_NAME$f]: preferExpectResolves,
    [RULE_NAME$e]: preferEach,
    [RULE_NAME$d]: preferHooksOnTop,
    [RULE_NAME$c]: preferHooksInOrder,
    [RULE_NAME$5]: requireLocalTestContextForConcurrentSnapshots,
    [RULE_NAME$b]: preferMockPromiseShorthand,
    [RULE_NAME$a]: preferSnapshotHint,
    [RULE_NAME$9]: validDescribeCallback,
    [RULE_NAME$8]: requireTopLevelDescribe,
    [RULE_NAME$7]: requireToThrowMessage,
    [RULE_NAME$6]: requireHook,
    [RULE_NAME$4]: preferTodo,
    [RULE_NAME$3]: preferSpyOn,
    [RULE_NAME$2]: preferComparisonMatcher,
    [RULE_NAME$1]: preferToContain,
    [RULE_NAME]: preferExpectAssertions
  },
  configs: {
