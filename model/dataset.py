...
class CustomListDataset(Dataset):
    ...
    def __getitem__(self, index):
        d = self.data[index]
        # Use labels as integers, not one-hot encoded vectors
        ...
        # Convert feature matrix from sparse to dense
        feature = torch.from_numpy(d['feature'].toarray())

        # Return input features and the two labels
        return feature, y_traffic, y_app, y_aux
